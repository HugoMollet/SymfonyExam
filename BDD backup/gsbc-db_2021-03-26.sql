...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 26 mars 2021 à 08:20
...
('DoctrineMigrations\\Version20201210080822', '2020-12-10 08:14:39', 1956);
...
INSERT INTO `utilisateur` (`id`, `nom`, `prenom`, `login`, `mdp`, `adresse`, `cp`, `ville`, `dateEmbauche`, `lacategory_id`) VALUES
...
('db1', 'Demay', 'boris', 'boris', '123', '7 rue des fleurs', '59480', 'la bassée', '2020-12-10', NULL),
...
ALTER TABLE `fichefrais`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unefiche` (`idUtilisateur`,`mois`) USING BTREE,
...
ALTER TABLE `utilisateur`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_1D1C63B3510B294E` (`lacategory_id`);
...
--
ALTER TABLE `utilisateur`
  ADD CONSTRAINT `FK_1D1C63B3510B294E` FOREIGN KEY (`lacategory_id`) REFERENCES `category` (`id`);
COMMIT;
